    ...
    <header className="flex justify-between items-center p-4">
      ...
      >
        <input
          type="text"
          placeholder="Ara..."
          className="group-hover:border-blue-500 group-hover:border border border-transparent bg-black text-white py-2 px-5 border-none outline-none rounded-l-[20px] focus:border-blue-500"
        />
